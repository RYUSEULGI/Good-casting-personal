...
public class QHire extends EntityPathBase<Hire> {
    ...
    private static final long serialVersionUID = -689441967L;
    ...
    public final shop.ryuseulgi.goodCasting.user.producer.domain.QProducer producer;
    ...
    public QHire(Class<? extends Hire> type, PathMetadata metadata, PathInits inits) {
        ...
        this.producer = inits.isInitialized("producer") ? new shop.ryuseulgi.goodCasting.user.producer.domain.QProducer(forProperty("producer"), inits.get("producer")) : null;
    }
