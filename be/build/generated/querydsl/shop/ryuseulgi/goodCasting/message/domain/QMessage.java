...
public class QMessage extends EntityPathBase<Message> {
    ...
    private static final long serialVersionUID = 568633881L;
    ...
    public final shop.ryuseulgi.goodCasting.user.login.domain.QUserVO receiver;

    //inherited
    public final DateTimePath<java.sql.Timestamp> regDate = _super.regDate;

    public final shop.ryuseulgi.goodCasting.user.login.domain.QUserVO sender;
    ...
    public QMessage(Class<? extends Message> type, PathMetadata metadata, PathInits inits) {
        ...
        this.receiver = inits.isInitialized("receiver") ? new shop.ryuseulgi.goodCasting.user.login.domain.QUserVO(forProperty("receiver")) : null;
        this.sender = inits.isInitialized("sender") ? new shop.ryuseulgi.goodCasting.user.login.domain.QUserVO(forProperty("sender")) : null;
    }
